...
const id: Messages = {
  ...
  markets: {
    ...
    movers: {
      stripLabel: "Bitget spot · 24 jam",
      trigger: "Naik / Turun 24 Jam",
      triggerAria: "Buka pergerakan pasar Bitget",
      gainers: "Naik",
      losers: "Turun",
      volume: "Volume",
      searchPair: "Cari pasangan…",
      colPair: "Pasangan",
      colLast: "Harga",
      colChange: "24j",
      refreshAria: "Muat ulang",
      empty: "Tidak ada pasangan yang cocok",
      error: "Data Bitget tidak tersedia — coba muat ulang",
      updated: "Diperbarui {time}",
      pairCount: "{count} pasangan",
      viewAll: "Bitget",
      pairAria: "Buka {pair} di Bitget",
    },
  },
  ...
  bot: {
    ...
    bestWorst: "Terbaik / terburuk",
    expectancy: "rata-rata {value} $/transaksi",
    pnl14d: "PnL terealisasi — 14 hari terakhir",
    cumLabel: "kum {value} $",
    exit_take_profit: "take-profit ×{count}",
    exit_stop_loss: "stop-loss ×{count}",
    exit_signal_flip: "sinyal-balik ×{count}",
    exit_other: "lainnya ×{count}",
    advTitle: "Lanjutan — kustom take-profit / stop-loss",
    advHint:
    ...
    pfTotal: "Semua bot — PnL gabungan",
    pfToday: "Hari ini",
