...
const en = {
  ...
  markets: {
    ...
    movers: {
      stripLabel: "Bitget spot · 24h",
      trigger: "Movers 24h",
      triggerAria: "Open Bitget market movers",
      gainers: "Gainers",
      losers: "Losers",
      volume: "Volume",
      ...
      colChange: "24h",
      refreshAria: "Refresh",
      empty: "No matching pair",
      error: "Bitget data unavailable — try refreshing",
      updated: "Updated {time}",
      pairCount: "{count} pairs",
      viewAll: "Bitget",
      pairAria: "Open {pair} on Bitget",
    },
  },
  ...
  bot: {
    ...
    expectancy: "avg {value} $/trade",
    pnl14d: "Realized PnL — last 14 days",
    cumLabel: "cum {value} $",
    exit_take_profit: "take-profit ×{count}",
    exit_stop_loss: "stop-loss ×{count}",
    exit_signal_flip: "signal-flip ×{count}",
    exit_other: "other ×{count}",
    advTitle: "Advanced — custom take-profit / stop-loss",
    advHint:
