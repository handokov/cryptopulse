...
const es: Messages = {
  ...
  markets: {
    ...
    movers: {
      ...
      trigger: "Movimientos 24 h",
      triggerAria: "Abrir movimientos de mercado de Bitget",
      gainers: "Suben",
      losers: "Bajan",
      volume: "Volumen",
      ...
      empty: "Ningún par coincide",
      error: "Datos de Bitget no disponibles — prueba a actualizar",
      updated: "Actualizado {time}",
      pairCount: "{count} pares",
      viewAll: "Bitget",
      pairAria: "Abrir {pair} en Bitget",
    },
  },
  ...
  bot: {
    ...
    expectancy: "media {value} $/operación",
    pnl14d: "PnL realizado — últimos 14 días",
    cumLabel: "acum {value} $",
    exit_take_profit: "take-profit ×{count}",
    exit_stop_loss: "stop-loss ×{count}",
    exit_signal_flip: "cambio de señal ×{count}",
    exit_other: "otro ×{count}",
    advTitle: "Avanzado — take-profit / stop-loss personalizados",
    advHint:
    ...
    pfTotal: "Todos los bots — PnL combinado",
    pfToday: "Hoy",
    pfAllTime: "Histórico",
